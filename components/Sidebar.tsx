...
const FileTreeItem: React.FC<{ 
    ...
    if (isFolder) {
        return (
            <div>
                <button
                    type="button"
                    className="w-full text-left flex items-center gap-1 py-1 px-2 hover:bg-black/5 dark:hover:bg-white/5 cursor-pointer theme-text opacity-70 hover:opacity-100 transition-colors select-none focus:outline-none focus-visible:ring-1 focus-visible:ring-brand-primary focus-visible:z-10"
    ...
    return (
        <div 
            className={`flex items-center justify-between group py-1 px-2 select-none transition-colors border-l-2 ${
        ...
        >
            <button
                type="button"
                className="flex-1 flex items-center gap-2 overflow-hidden text-left focus:outline-none focus-visible:ring-1 focus-visible:ring-brand-primary rounded-sm"
            ...
            <button 
                ...
                className="opacity-0 group-hover:opacity-100 p-0.5 hover:bg-black/10 dark:hover:bg-white/10 rounded text-gray-500 hover:text-red-400 focus:opacity-100 focus:outline-none focus-visible:ring-1 focus-visible:ring-brand-primary"
            >
