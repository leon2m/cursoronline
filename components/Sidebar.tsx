...
const FileTreeItem: React.FC<{ 
    ...
    return (
        ...
        >
            <button
                type="button"
                className="flex items-center gap-2 overflow-hidden flex-1 text-left focus:outline-none focus-visible:ring-1 focus-visible:ring-brand-primary"
            ...
            <button 
                ...
                className="opacity-0 group-hover:opacity-100 p-0.5 hover:bg-black/10 dark:hover:bg-white/10 rounded text-gray-500 hover:text-red-400 focus:opacity-100 focus:outline-none focus-visible:ring-1 focus-visible:ring-red-400"
